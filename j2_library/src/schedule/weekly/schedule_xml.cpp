...
namespace j2::schedule::weekly {
    ...
    std::string to_xml(const weekly_ranges& ranges) {
        ...
        // XMLPrinter::CStr() 는 null-terminated C 문자열을 반환
